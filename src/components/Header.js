...
// import { Link } from "react-router-dom";
// import logo from "/public/CANTEEN-removebg-preview.png"
...
//     return (
//         <div className="flex justify-between bg-green-300 h-40 rounded-md">
//             <div>
//                 <img className="w-30 h-32 m-5" src={logo} alt="Logo" ></img>
//             </div>
//             <div className="nav-items">
//                 <ul className="flex p-4 m-4">
//                     <li className="mr-2 bg-blue-400 rounded-sm p-2 m-2 "><Link to="/" className="nav-link">Online Status :{onlineStatus ? "✅" : "🔴" }</Link></li>
//                     <li className="mr-2 bg-blue-400 rounded-sm p-2 m-2"><Link to="/" className="nav-link">Home</Link></li>
//                     <li className="mr-2 bg-blue-400 rounded-sm p-2 m-2"><Link to="/about" className="nav-link">About</Link></li>
//                     <li className="mr-2 bg-blue-400 rounded-sm p-2 m-2"><Link to="/contact" className="nav-link">Contact</Link></li>
//                     <li className="mr-2 bg-blue-400 rounded-sm p-2 m-2"><Link to="/grocery" className="nav-link">Grocery</Link></li>
//                     <li className="mr-2 bg-blue-400 rounded-sm p-2 m-2"><Link to="/cart" className="nav-link">Cart</Link></li>
//                     <button
//                      className="mr-2 bg-blue-400 rounded-sm p-2 m-2 h-50 w-50"
//                      onClick= {() => { 
//                         btnNameReact == "Login"
